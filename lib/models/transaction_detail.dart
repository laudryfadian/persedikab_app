class TrxDetail {
  ...
  TrxDetail.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  ...
  late final List<ItemDetails> itemDetails;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    itemDetails = List.from(json['item_details'])
...
class ItemDetails {
  ...
  late final IdProduk idProduk;
  late final int price;
  late final int quantity;
  late final int ongkir;
  late final String ukuran;
  late final String name;
  late final String id;

  ItemDetails.fromJson(Map<String, dynamic> json) {
    idProduk = IdProduk.fromJson(json['idProduk']);
    price = json['price'];
  ...
  Map<String, dynamic> toJson() {
    final _data = <String, dynamic>{};
    _data['idProduk'] = idProduk.toJson();
    _data['price'] = price;
...
class IdProduk {
  ...
  late final String id;
  late final String kodeProduk;
  late final String nama;
  late final String gambar;

  IdProduk.fromJson(Map<String, dynamic> json) {
    id = json['_id'];
